...
2. **Resume Analyzer** — Extracts the full text from the candidate's PDF resume using PyMuPDF and scores the candidate against the extracted requirements, identifying strengths and gaps.
...
- A [Heroku](https://heroku.com) account for the frontend
- A [CrewAI AMP](https://crewai.com) deployment for the backend

## Deployment

### 1. CrewAI AMP (backend)
